...
<body
    ...
    <span class="preheader"
        style="color: transparent; display: none; font-size: 1px; height: 0; opacity: 0; visibility: hidden; width: 0;">Join Mood Enquiry</span>
		<table
                                                        ...
                                                        <tr>
                                                            <td style="height: 40px; line-height: 40px; mso-line-height-rule: exactly;"
                                                                ...
                                                                <a href="#"
                                                                    ...
                                                                    <img src="{{ asset('img/logo/mood-logo.png') }}" alt="image"
