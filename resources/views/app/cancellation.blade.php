            ...
            <div class="col-sm-12">
                <div class="static-page-box-outer">
                    <div class="static-page-box">
                        <h1 style="font-family:'Montserrat-Medium'; color:#8F8F8F">{{$cancel->title}}</h1>
                        <p style="font-family:'Montserrat-Medium'; color:#8F8F8F; font-size: 15px;">{!!$cancel->description!!}</p>
                    </div>
                </div>
            </div>
        </div>
