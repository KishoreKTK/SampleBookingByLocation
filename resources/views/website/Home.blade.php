...
<section class="page-main page-current" id="home">
    ...
    <div class="container display-flex">
        <div class="row">
            <div
                class="col-sm-7 col-12 display-flex justify-content-md-left justify-content-center text-md-left text-center">
            ...
            <div class="col-sm-4 col-12 display-flex wow fadeInUp">
                <div class="images-container flex">
                    <img class="first-image" src="{{ asset('webassets/images/white-phone.png') }}" alt="">
                </div>
            </div>
        </div>
...
<section class="features-area-five" id="about">
    <img class="shape-img" src="{{ asset('webassets/images/shape.png') }}" alt="">
...
<section class="screenshot_area_three" id="screenshot">
    <div class="container wow fadeInUp">
        <div class="title-four title-six text-center">
            ...
            <div class="br"></div>
            <p>Mood is a on-demand beauty and wellness home-service business. We are female-founded and UAE-born. Mood
                aggregates the best home-service businesses to ensure only top quality experiences to you. Book
                anywhere, anytime.</p>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img class="img-responsive"
                                src="{{ asset('webassets/images/one.jpg') }}" alt=""></div>
                        <div class="swiper-slide"><img class="img-responsive"
                                src="{{ asset('webassets/images/two.jpg') }}" alt=""></div>
                        <div class="swiper-slide"><img class="img-responsive"
                                src="{{ asset('webassets/images/three.jpg') }}" alt=""></div>
                        <div class="swiper-slide"><img class="img-responsive"
                                src="{{ asset('webassets/images/four.jpg') }}" alt=""></div>
                        <!-- <div class="swiper-slide"><img class="img-responsive" src="{{ asset('webassets/images/five.jpg') }}" alt=""></div> -->
