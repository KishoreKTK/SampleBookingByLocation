...
<head>
    ...
    <link rel="stylesheet"
        href="{{ url('/')}}/public/webassets/vendor/intl-tel-input-master/build/css/intlTelInput.min.css">
...
<body data-spy="scroll" data-target=".navbar" data-offset="75">
            ...
            <div class="row call-action">
                <div class="col-md-7">
                    <div class="call-text wow fadeInUp">
                        ...
                        <div class="d-flex justify-content-md-start justify content-center"> <a href="#"
                                class="app-btn2 active">
                ...
                <div class="col-sm-5">
                    <div class="call-mobile-img wow fadeInUp">
                        <img class="img-fluid" src="{{ url('/')}}/public/webassets/images/image_double_iphone.png"
                            alt="">
    ...
    <script src="{{ url('/')}}/public/webassets/vendor/intl-tel-input-master/build/js/intlTelInput-jquery.min.js">
    </script>
    <script>
    new WOW().init();
    // ================================================
