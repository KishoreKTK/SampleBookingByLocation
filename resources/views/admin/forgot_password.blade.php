...
<div class="container">
    <div class="row">
        <div class="col-sm-12 align-self-center">
            ...
            {!! Form::open(['url' => env('ADMIN_URL')."/forgot_password",'id'=>'validate-form','class'=>"md-float-material
                ...
                <div class="card-block pt-2">
                    ...
                    <div class="row">
                        <div class="col-md-10  col-10">
                            ...
                            <p class=" text-left"><a href="{{env('ADMIN_URL')}}/"><b>Back to Login</b></a>
                            </p>
                        </div>
                        <div class="col-md-2  col-2">
                             <img src="{{asset('img/logo/logo_icon.png') }}"
                                style="width:32 px; float:right;"
                                alt="small-logo.png">
                        </div>
                    </div>
                </div>
