    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <!-- <form id="main" method="post" action="/" novalidate> -->
                {!! Form::open(["url"=>env('ADMIN_URL')."/salons/edit","id"=>"main","method"=>"post",'files'=> true]) !!}
            @csrf
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Name</label>
                    <div class="col-sm-10">
                        {!! Form::text("name",$salon->name,["placeholder"=>"Name","id"=>"name","class"=>"form-control",'required' => 'required']) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text("sub_title",$salon->sub_title,["placeholder"=>"Sub Title","id"=>"name","class"=>"form-control",'required' => 'required']) !!}
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text("pricing",$salon->pricing,["placeholder"=>"Commission","id"=>"name","class"=>"form-control"]) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text("email",$salon->email,["placeholder"=>"Email","id"=>"name","class"=>"form-control",'required' => 'required']) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text("phone",$salon->phone,["placeholder"=>"Contact Number","id"=>"name","class"=>"form-control",'required' => 'required']) !!}
...
<!--
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <small class="form-text text-muted">Formats: JPG PNG, Sizes: 1366 x 768px or 1280 x 720px, Max 400KB</small>
            ...
            <br>
                ...
                <a href="{{env('ADMIN_URL')}}/salons/image/delete?id={{$value['id']}}" class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                </div>
            ...
            <div class="form-group row">
               ...
               <!--  <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::select("country",$countries,$salon->country_id,["placeholder"=>"Country","id"=>"name","class"=>"form-control",'required' => 'required']) !!}
...
{{--
                  ...
                  {!! Form::file('sub_images[]', null, ['class'=>'form-control']) !!}
                    ...
                    <div class="input-group-btn">
                      <button class="btn btn-success add-more" type="button"><i class="glyphicon glyphicon-plus"></i> </button>
                        ...
                        {!! Form::file('sub_images[]', null, ['class'=>'form-control','placeholder'=>'Choose an image']) !!} --}}
