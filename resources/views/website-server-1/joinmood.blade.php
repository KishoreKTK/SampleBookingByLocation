...
<section class="analysis_area_two" id="service-provider">
    <div class="container">
            ...
            <div class="row justify-content-center wow fadeInUp">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <input name="phone_number" type="tel" class="form-control" required id="telephone" value="">
                    </div>
                ...
                <div class="col-lg-10">
                    <div class="form-group">
                        <div class="mb-3">
                            <label for="inputEmail4" class="mb-0">Select your primary two categories (max. of 2)</label>
                            <div class="clearfix"></div>
                        ...
                        @foreach ($category_list as $key=>$cat)
                            <div class="custom-control custom-checkbox custom-control-inline category-checkbox">
                                <input type="checkbox" name="categories[]" class="custom-control-input" id="customCheck{{ $key+1 }}" value="{{ $cat->id }}">
                                <label class="custom-control-label" for="customCheck{{ $key+1 }}" >{{ $cat->category }}</label>
                            </div>
                        @endforeach
                ...
                <div class="col-lg-2 pt-4">
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary btn-black btn-lg d-block mx-auto d-block">Submit</button>
                    </div>
                </div>
                <div class="w-100"></div>
