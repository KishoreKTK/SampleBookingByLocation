            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-12 display-flex wow fadeInUp">
                    <div class="images-container flex">
                        <img class="first-image" src="{{ url('/')}}/WebPageAsset/images/white-phone.png" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img class="img-responsive" src="{{ url('/')}}/WebPageAsset/images/one.jpg" alt=""></div>
                            <div class="swiper-slide"><img class="img-responsive" src="{{ url('/')}}/WebPageAsset/images/two.jpg" alt=""></div>
                            <div class="swiper-slide"><img class="img-responsive" src="{{ url('/')}}/WebPageAsset/images/three.jpg" alt=""></div>
                            <div class="swiper-slide"><img class="img-responsive" src="{{ url('/')}}/WebPageAsset/images/four.jpg" alt=""></div>
                            <!-- <div class="swiper-slide"><img class="img-responsive" src="{{ url('/')}}/WebPageAsset/images/five.jpg" alt=""></div> -->
