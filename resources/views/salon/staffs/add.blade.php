...
<div class="page-wrapper">
    ...
    <div class="card">
        ...
        <div class="panel-body">
            ...
            <a href="{{ env('ADMIN_URL') }}/salon/services/add?id={{$salon_id}}" class="btn btn-primary m-b-0" style="float:right">Add Services</a></p>
        </div>
        @endif
        <div class="card-block">
        @include('includes.msg')

        {!! Form::open(["url"=>env('ADMIN_URL')."/salon/staffs/add","id"=>"main","method"=>"post",'files'=> true]) !!}
            @csrf
