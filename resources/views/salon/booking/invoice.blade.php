...
<table align="center" width="95%" style="margin: 0 auto;">
    <tbody>
        <tr>
            ...
            border-color: #cc9c83;"><a href=""><img style="width:155px; height:42px;" src="{{url('/')}}/img/logo/mood-white-logo.png" alt=""></a></td>
        </tr>
    </tbody>
    ...
    <tbody>
        ...
        <tr>
            <td align="left" style="padding:10px 20px;font-size: 13px;font-family: 'Roboto', sans-serif;">
                ...
                <font face="'Roboto', sans-serif">{{$booking->first_name}} {{$booking->last_name}}<br> {{$booking->address}}
                </font>
            ...
            <td align="right" style="padding:10px 20px;font-family: 'Roboto', sans-serif;">
                <h6 style="font-size: 14px; font-weight:500;">
                    <font face="'Roboto', sans-serif">INVOICE ID: {{$booking->orderId}}</font>
                </h6>
                <h6 style="font-size: 14px; font-weight:500;">
...
<table align="center" width="95%" style="margin: 0 auto;">
    <thead stya>
        <tr>
            ...
            background-color: #cc9c83;
            border-color: #cc9c83; text-align: left;font-size: 13px;">
                <font face="'Roboto', sans-serif">{{$booking->name}}</font>
            </th>
            <th align="right" style="padding:6px 10px;color: #fff;
              background-color: #cc9c83;
              border-color: #cc9c83; text-align: right;font-size: 13px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="right" style="padding:6px 10px;
                                  text-align: right;font-size: 13px;border-bottom: 1px solid #dee2e6;">
                <font face="'Roboto', sans-serif">{{$booking->actual_amount}} AED</font>
            </td>
        </tr>
        <tr>
            <td align="left" style="padding:6px 10px;
            ...
            <td align="right" style="padding:6px 10px;
                                      text-align: right;font-size: 13px;border-bottom: 1px solid #dee2e6;">
                <font face="'Roboto', sans-serif">{{$booking->amount}} AED</font>
            </td>
        </tr>
