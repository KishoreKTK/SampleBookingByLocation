        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{env('ADMIN_URL')}}/salon/working_hours">Working Hours</a></li>
...
<div class="page-wrapper">
    ...
    <div class="card">
        ...
        {!! Form::open(["url"=>env('ADMIN_URL')."/salon/working_hours/edit","id"=>"main","method"=>"post",'files'=> true]) !!}
            @csrf
