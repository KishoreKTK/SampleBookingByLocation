                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{env('ADMIN_URL')}}/salon/customers">Customers</a></li>
                                                    ...
                                                    <table class="table table-sm table-hover">
                                                        <tbody>
                                                            ...
                                                            {{-- <tr data-toggle="tooltip" data-placement="right"
                                                                ...
                                                                <td></td>
                                                                <td><a href="{{env('ADMIN_URL')}}/users/activity_log?id={{$user->id}}"><button type="button" class="btn btn-primary">Activity Log</button></a>
                                                                </td>
                                                            </tr> --}}
                                                            {{-- <tr data-toggle="tooltip" data-placement="right"
                                                                title="Booking Count">
                                                                <td>No.Booking </td>
                                                                <td><span class="badge badge-success">{{ count($booking) }}</span></td>
                                                            </tr>
                                                            $booking --}}
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-12">
                                ...
                                <div class="card main-tab-head">
                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
                                        ...
                                        {{-- <li class="nav-item m-b-0">
                                            <a class="nav-link f-18 p-b-0" data-toggle="tab" href="#address"
                                                role="tab">Address</a>
                                            <div class="slide"></div>
                                        </li> --}}
                                                        ...
                                                        <tbody>
                                                            @if(isset($address)&& count($address)>0)
                                                                ...
                                                                <tr>
                                                                    <td>{{$index+1 }}</td>
                                                                    <td>
                                                                        <strong>{{ $addr->first_name }}</strong>
                                                                        <p><a href="tel:{{ $addr->phone_num }}"><span class="badge btn-primary">{{ $addr->phone_num }}</span></a></p>
                                                                    </td>
                                                                    <td>
                                                                        <p>{{ $addr->address }}</p>
                                                                        <p><span class="badge btn-secondary">{{ $addr->location }}</span> |
                                                                            <span class="badge btn-secondary">{{ $addr->city }}</span></p>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                                            @else
                                                                <tr>
                                                                    <td colspan='3'>No address yet</td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
