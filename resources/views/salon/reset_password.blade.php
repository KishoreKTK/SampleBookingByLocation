...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            ...
            {!! Form::open(['url' => env('ADMIN_URL').'/salon/reset_password','id'=>'validate-form','class'=>"md-float-material
            ...
            <div class="text-center">
                ...
                <a href=""> <img src="{{asset('img/logo/mood-white-logo.png') }}"
            ...
            <div class="auth-box card">
                <div class="card-block">
                    ...
                    <div class="row m-t-10">
                        <div class="col-md-10">
                            <a href="{{env('ADMIN_URL')}}/salon/login" class="text-right f-w-600"> Back to
                                Login</a>
                        </div>
                        <div class="col-md-2">
                            <a href="#"> <img src="{{asset('img/logo/logo_icon.png') }}"
