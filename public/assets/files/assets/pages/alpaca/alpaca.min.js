! function(e, t) {
    ...
    return this.HandlebarsPrecompiled = this.HandlebarsPrecompiled || {}, this.HandlebarsPrecompiled["web-display"] = this.HandlebarsPrecompiled["web-display"] || {}, this.HandlebarsPrecompiled["web-display"]["container-array-item"] = Handlebars.template({ 1: function(e, t, n, i, a) {
        ...
        function(e) {
            var t = e.alpaca,
                n = {};
            n.button = "btn btn-default", n.smallButton = "btn btn-default btn-sm", n.addIcon = "icofont icofont-plus-circle", n.removeIcon = "icofont icofont-minus-circle", n.upIcon = "icofont icofont-rounded-up", n.downIcon = "icofont icofont-rounded-down", n.expandedIcon = "glyphicon glyphicon-circle-arrow-down", n.collapsedIcon = "glyphicon glyphicon-circle-arrow-right", n.table = "table table-sm table-hover table-bordered table-hover";
            var i = {};
            i.required = function() {
