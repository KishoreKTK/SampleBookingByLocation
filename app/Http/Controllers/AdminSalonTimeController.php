...
class AdminSalonTimeController extends Controller
{
    public function edit(Request $request)
    {
        ...
        else 
        {
        	...
        	return view("admin.working_hours.edit", compact('salon_id','time','activePage'));
        }
    }
    public function edit_time(Request $request)
    {
      $rules=[
        ...
        else 
        {
            ...
            if($new_time)
            {
                return redirect()->back()->with("error", false)->with("msg", "Your working hours updated successfully")->withInput();
            }
            else
            {
