...
class SalonServicesController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $categories =   DB::table('salon_categories')
                        ->select('category_id as id','categories.category as category')
                        ->where('salon_id','=',$salon_id)
                        ->join('categories','salon_categories.category_id','=','categories.id')
                        ->groupBy('salon_categories.category_id')
                        ->get();
    ...
    public function categories(Request $request)
    {
        ...
        $categories =   DB::table('salon_categories')
        ->select('category_id as id','categories.category as category','categories.image','categories.created_at')
        ->where('salon_id','=',$salon_id)
        ->join('categories','salon_categories.category_id','=','categories.id')->paginate(20);
